...
export const ModificarContacto = (props) => {
  ...
  function onSubmit(e) {
    ...
    var valido = true;
    nombre = setNombre(props.nombre);
    apellido = setApellido(props.apellido);
    telefono = setTelefono(props.telefono);
    correo = setCorreo(props.correo);
    favorito =setfavorito(props.favorito);
